...
const aliquotasDoImposto = pegarAliquota(valorSalarioBruto);
const valorImposto = calcularPorcentagem(valorSalarioBruto, aliquotasDoImposto);
const valorATransferir = valorSalarioBruto - valorImposto + valorAdicionalBeneficio;
